...
namespace Learn.Core.Data
{
    ...
    public class ConvertExtension
    {
        ...
        public static dynamic DataFillDynamic(IDataReader reader)
        {
            using (reader)
            {
                return ReaderToDynamic(reader);
            }
        }

        private static dynamic ReaderToDynamic(IDataReader reader)
        {
            ...
            {
                itemDictionary.Add(reader.GetName(i), reader.IsDBNull(i) ? null : reader.GetValue(i));
            }
        ...
        public static List<dynamic> DataFillDynamicList(IDataReader reader)
        {
            using (reader)
            {
                ...
                if (reader != null && !reader.IsClosed)
                {
                    while (reader.Read())
                    {
                        list.Add(ReaderToDynamic(reader));
                    }
                    reader.Close();
                    reader.Dispose();
                }
        ...
        public static List<T> IDataReaderToList<T>(IDataReader reader)
        {
            ...
            {
                return DataFillDynamicList(reader) as List<T>;
            }
            using (reader)
            {
